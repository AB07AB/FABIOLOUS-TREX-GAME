...
//-------------------STARS------------------
GoldStarIMG = loadImage("Imported piskel.gif");

BronzeStarIMG = loadImage("Imported piskel (1).gif")
...
function draw() {
  ...
  if(starGroup.isTouching(trex)){
    ...
    textSize(20)
    textFont("Georgia")
    text("You Won The Super Star", 300,570)
    gameOver.visible=false
...
function bronzeStars(){
  if (frameCount % 50 === 0){
    ...
    if(bronzeGroup.isTouching(trex)){
      //bronzeGroup.setVelocityXEach(0)
      //bronzeGroup.setLifetimeEach(5)
    }
    if(bronzeGroup.isTouching(trex2)){
     // bronzeGroup.setVelocityXEach(0)
     // bronzeGroup.setLifetimeEach(5)
...
function spawnStars() {
  ...
  if (frameCount % 10000 === 0) {
    ...
    var star1 = createSprite(600,600,40,10);
